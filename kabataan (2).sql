...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2025 at 01:15 PM
...
(5, 'Brent Paulo', 'Bolanos', 'ifdhjbjkfhb@gmail.com', 7, 1);

-- --------------------------------------------------------

--
-- Table structure for table `username_seq`
--

CREATE TABLE `username_seq` (
  `seq_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `username_seq`
--

INSERT INTO `username_seq` (`seq_id`, `created_at`) VALUES
(1, '2025-11-11 04:38:07'),
(2, '2025-11-11 05:03:39'),
(6, '2025-11-11 05:07:22'),
(7, '2025-11-11 06:10:48'),
(8, '2025-11-11 06:27:09'),
(9, '2025-11-11 06:30:29'),
(10, '2025-11-11 10:00:12'),
(11, '2025-11-11 10:12:43'),
(12, '2025-11-11 10:57:42'),
(13, '2025-11-11 11:03:36'),
(14, '2025-11-11 11:06:33'),
(15, '2025-11-11 11:08:21'),
(16, '2025-11-11 11:15:31'),
(17, '2025-11-11 11:28:00');
...
(17, 'Nicole', 'kurt', -1, 'Male', 'Lalud', '2025-11-07', NULL),
(18, 'Paul', 'kurt', 0, 'Female', 'asdasd', '2025-10-30', NULL),
(19, 'Nicole', 'asddsad', 0, 'Female', 'dasdsaasd', '2025-09-25', NULL);
...
--
-- Indexes for table `username_seq`
--
ALTER TABLE `username_seq`
...
--
-- AUTO_INCREMENT for table `username_seq`
--
ALTER TABLE `username_seq`
  MODIFY `seq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
