...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 13, 2025 at 08:20 AM
...
CREATE TABLE `budget` (
  ...
  `InitialBalanceSet` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `budget` (`budget_id`, `Barangay_ID`, `budget`, `disbursed`, `balance`, `Term_ID`, `InitialBalanceSet`) VALUES
(1, 5, 52000.00, 2000.00, 5200.00, 1, 0),
(2, 58, 200000.00, 0.00, 25000.00, 1, 0);
...
CREATE TABLE `compliance` (
  ...
  `Annex_Type` varchar(255) DEFAULT NULL,
...
INSERT INTO `compliance` (`com_id`, `Barangay_id`, `File_ID`, `Title`, `Type`, `Annex_Type`, `Status`, `due_date`, `Date_Submitted`, `Term_ID`, `IsArchived`, `TemplateFile_ID`) VALUES
(1, 5, NULL, 'Completion Report: hatdog', 'Project Completion Report', 'Summary', 'Pending', '2025-12-28', '2025-12-13 14:54:34', 1, 0, NULL);
...
(1, 1, 52, 'Pending', NULL, '2025-12-13 14:54:34');
...
(1, 1, 10000000.00, 252000.00, '2025-12-13 14:37:27');
...
(45, 'Projec_temp.pdf', '/UploadedFiles/Projec_temp_20251213122408_8917c4.pdf', 9, '2025-12-13 12:24:08'),
(46, 'content.pdf', '/UploadedFiles/content_20251213122409_fe0e94.pdf', 9, '2025-12-13 12:24:09'),
(47, 'SK_financial_template.pdf', '/UploadedFiles/SK_financial_template_20251213122409_8518de.pdf', 9, '2025-12-13 12:24:09'),
(48, 'content.pdf', '/UploadedFiles/content_20251213141723_8c806d.pdf', 9, '2025-12-13 14:17:23'),
(49, 'Projec_temp.pdf', '/UploadedFiles/Projec_temp_20251213141723_74d655.pdf', 9, '2025-12-13 14:17:23'),
(50, 'SK_financial_template.pdf', '/UploadedFiles/SK_financial_template_20251213143852_0e6115.pdf', 9, '2025-12-13 14:38:52'),
(51, 'Projec_temp.pdf', '/UploadedFiles/Projec_temp_20251213143852_15f86d.pdf', 9, '2025-12-13 14:38:52'),
(52, 'Projec_temp.pdf', '/UploadedFiles/Submissions/1_20251213145434_568407.pdf', 9, '2025-12-13 14:54:34');
...
(9, 15, 1, 3, 'Resigned', '2025-12-13'),
(10, 16, 1, 3, 'Resigned', '2025-12-13'),
(11, 17, 1, 3, 'Active', NULL),
(12, 18, 1, 3, 'Active', NULL);
...
(18, 'SK0010', 'AQAAAAIAAYagAAAAEB/Uy3Ymy/TZiLuLlBy8Z3qctzcD+peB2+hBs41209X7bYeOvi4EPDTkLpBV6xnE4A==', 3, 18);
...
(1, 9, 1, 50, 'hatdog', 'rgfrfr', 0.00, '2025-12-13', 'Completed', '2026-04-15', '2026-04-23', 0);
...
(1, 1, 50, '2025-12-13 14:38:52.461629', 'Project Proposal'),
(2, 1, 51, '2025-12-13 14:38:52.522259', 'Annex A');
...
(29, 17, 9, 'Pending', '2025-12-13 12:24:09', 'Project created and submitted for approval.'),
(30, 17, 9, 'Pending', '2025-12-13 12:28:19', 'Project status updated to Pending by Federation President'),
(31, 17, 9, 'Approved', '2025-12-13 12:29:13', 'Project status updated to Approved by Federation President'),
(32, 18, 9, 'Pending', '2025-12-13 14:17:23', 'Project created and submitted for approval.'),
(33, 1, 9, 'Pending', '2025-12-13 14:38:52', 'Project created and submitted for approval.'),
(34, 1, 9, 'Approved', '2025-12-13 14:41:15', 'Project status updated to Approved by Federation President');
...
(188, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 11:59:16'),
(189, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:01:58'),
(190, 5, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:07:48'),
(191, 5, 'Create User', 'User', 18, 'Created User: SK0010', '2025-12-13 12:08:50'),
(192, 18, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:09:28'),
(193, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:09:58'),
(194, 7, 'Add Budget', 'Budget', 6, 'Added budget to San Vicente North: ₱500,000.00 (New Total: ₱500,000.00)', '2025-12-13 12:12:30'),
(195, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:12:47'),
(196, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:15:59'),
(197, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:16:46'),
(198, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:17:29'),
(199, 9, 'Create Project', 'Project', 17, 'Created Project: year end party with 1 proposal documents and 2 annex documents', '2025-12-13 12:24:09'),
(200, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:24:21'),
(201, 5, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:26:21'),
(202, 5, 'Archive User', 'User', 16, 'Resigned/Archived User: SK0008', '2025-12-13 12:26:37'),
(203, 5, 'Archive User', 'User', 15, 'Resigned/Archived User: SK0007', '2025-12-13 12:26:41'),
(204, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:28:10'),
(205, 7, 'Approve/Reject Project', 'Project', 17, 'Project \'year end party\' status updated to Pending', '2025-12-13 12:28:19'),
(206, 7, 'Approve/Reject Project', 'Project', 17, 'Project \'year end party\' status updated to Approved', '2025-12-13 12:29:13'),
(207, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:32:42'),
(208, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:35:06'),
(209, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:35:45'),
(210, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:43:11'),
(211, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:46:09'),
(212, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:46:27'),
(213, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:48:10'),
(214, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:52:42'),
(215, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:53:26'),
(216, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:56:10'),
(217, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 12:57:45'),
(218, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:00:23'),
(219, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:00:49'),
(220, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:07:41'),
(221, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:09:11'),
(222, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:11:41'),
(223, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:16:20'),
(224, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:18:11'),
(225, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:22:00'),
(226, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:28:26'),
(227, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:30:19'),
(228, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:49:17'),
(229, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:53:06'),
(230, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:56:17'),
(231, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:57:45'),
(232, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 13:58:41'),
(233, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:03:37'),
(234, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:05:33'),
(235, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:08:13'),
(236, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:10:51'),
(237, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:11:12'),
(238, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:12:45'),
(239, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:15:36'),
(240, 9, 'Create Project', 'Project', 18, 'Created Project: hatdog with 1 proposal documents and 1 annex documents', '2025-12-13 14:17:23'),
(241, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:19:49'),
(242, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:23:08'),
(243, 5, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:23:33'),
(244, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:23:56'),
(245, 7, 'Add Budget', 'Budget', 1, 'Added budget to Bayanan I: ₱500,000.00 (New Total: ₱500,000.00)', '2025-12-13 14:24:19'),
(246, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:24:32'),
(247, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:26:33'),
(248, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:28:21'),
(249, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:29:17'),
(250, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:31:52'),
(251, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:33:48'),
(252, 5, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:37:20'),
(253, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:37:38'),
(254, 7, 'Add Budget', 'Budget', 1, 'Added budget to Bayanan I: ₱50,000.00 (New Total: ₱50,000.00)', '2025-12-13 14:37:58'),
(255, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:38:14'),
(256, 9, 'Create Project', 'Project', 1, 'Created Project: hatdog with 1 proposal documents and 1 annex documents', '2025-12-13 14:38:52'),
(257, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:41:07'),
(258, 7, 'Approve/Reject Project', 'Project', 1, 'Project \'hatdog\' status updated to Approved', '2025-12-13 14:41:15'),
(259, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:41:35'),
(260, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:46:01'),
(261, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:46:32'),
(262, 9, 'Update Project', 'Project', 1, 'Updated Project hatdog status to Completed', '2025-12-13 14:46:47'),
(263, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:54:19'),
(264, 9, 'Submit Compliance', 'Compliance', 1, 'Submitted 1 documents for: Completion Report: hatdog', '2025-12-13 14:54:34'),
(265, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:54:43'),
(266, 9, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:55:40'),
(267, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 14:58:05'),
(268, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 15:08:54'),
(269, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 15:10:57'),
(270, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 15:13:49'),
(271, 7, 'Update Budget', 'Budget', 1, 'Updated budget for Bayanan I: Added ₱2,000.00 (Previous: ₱50,000.00, New: ₱52,000.00)', '2025-12-13 15:14:25'),
(272, 11, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 15:16:50'),
(273, 7, 'Login', NULL, NULL, 'User Logged In', '2025-12-13 15:17:11'),
(274, 7, 'Add Budget', 'Budget', 2, 'Added budget to Suqui: ₱200,000.00 (New Total: ₱200,000.00)', '2025-12-13 15:17:34');
...
(15, 'Brent Paulosddfdf', 'Bolanos', 'bolanos.brentpaulo07@gmail.com', 16, 3, 1, 1, NULL),
(16, 'Brent Paulosddfdf', 'Brent Paulosddfdfasdsadsad', 'dsaddasd@bms.com', 19, 3, 1, 1, NULL),
(17, 'Kurt', 'Tugas', 'itzkurt@gmail.com', 4, 3, 0, 1, NULL),
(18, 'Aiken', 'Faeldo', 'ben@gmail.com', 13, 3, 0, 1, NULL);
...
--
ALTER TABLE `system_log`
  MODIFY `SysLog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;
